...
public class MoverS extends my.test.Cubies.model.Mover {
    public MoverS () {
        super ();
        if (sMoveToList == null) {
            ...
            sMoveToList.put      (CubieLabel.U, CubieLabel.L);
            ...
            sMoveToList.put      (CubieLabel.L, CubieLabel.D);
            ...
            sMoveToList.put      (CubieLabel.R, CubieLabel.U);
            sOrientationList.put (CubieLabel.R, 0);
            sMoveToList.put      (CubieLabel.D, CubieLabel.R);
            ...
            sMoveToList.put      (CubieLabel.UL, CubieLabel.DL);
            sOrientationList.put (CubieLabel.UL, 1);
            sMoveToList.put      (CubieLabel.UR, CubieLabel.UL);
            sOrientationList.put (CubieLabel.UR, 1);
            ...
            sMoveToList.put      (CubieLabel.DR, CubieLabel.UR);
            sOrientationList.put (CubieLabel.DR, 1);
            sMoveToList.put      (CubieLabel.DB, CubieLabel.DB); // No changes
            sOrientationList.put (CubieLabel.DB, 0);
            sMoveToList.put      (CubieLabel.DL, CubieLabel.DR);
            sOrientationList.put (CubieLabel.DL, 1);
